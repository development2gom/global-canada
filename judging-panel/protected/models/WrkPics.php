...
class WrkPics extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ID, id_contest, txt_file_name, txt_pic_name', 'required'),
	...
	public function relations()
	{
		...
		return array(
			...
			'idCategoryOriginal' => array(self::BELONGS_TO, 'Categoiries', 'id_category_original'),
			'idContest' => array(self::BELONGS_TO, 'Contests', 'id_contest'),
			'iD' => array(self::BELONGS_TO, 'UsrUsuarios', 'ID'),
			'idPic'=>array(self::BELONGS_TO, 'ViewPicsCalificaciones', 'id_pic'),
			'WrkPicsCalificaciones' => array(self::HAS_MANY, 'WrkPicsCalificaciones', 'id_pic','order'=>'id_juez ASC'),
		);
	}
