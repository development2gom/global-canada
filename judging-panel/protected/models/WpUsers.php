 ...
 * @property 2gomOrderOpenpay[] $2gomOrderOpenpays
 * @property 2gomPaymentsRecibed[] $2gomPaymentsRecibeds
 * @property 2gomContests[] $2gomContests
 * @property 2gomRelUsersContestsPayments[] $2gomRelUsersContestsPayments
 * @property 2gomWrkPics[] $2gomWrkPics
 */
class WpUsers extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'2gomOrderOpenpays' => array(self::HAS_MANY, '2gomOrderOpenpay', 'ID'),
			'2gomPaymentsRecibeds' => array(self::HAS_MANY, '2gomPaymentsRecibed', 'ID'),
			'2gomContests' => array(self::MANY_MANY, '2gomContests', '2gom_rel_users_contest(ID, id_contest)'),
			'2gomRelUsersContestsPayments' => array(self::HAS_MANY, '2gomRelUsersContestsPayments', 'ID'),
	 ...
	 * @return WpUsers the static model class
	 */
