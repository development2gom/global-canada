...
/**
 * This is the model class for table "2gom_view_users_products".
 *
 * The followings are the available columns in table '2gom_view_users_products':
 ...
 */
class ViewUsersProducts extends CActiveRecord
{
	/**
	...
	{
		return '2gom_view_users_products';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('num_fotos_permitidas', 'numerical', 'integerOnly'=>true),
			array('num_sub_total, num_total', 'numerical'),
			array('id_usuario, id_usuario_facebook', 'length', 'max'=>11),
			array('txt_correo, txt_usuario_number, txt_nombre, txt_apellido_paterno, txt_apellido_materno, txt_order_number', 'length', 'max'=>50),
	 ...
	 * @return ViewUsersProducts the static model class
	 */
