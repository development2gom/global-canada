	...
	<section class="dgom-ui-pintar-photo-wrap">
		<div class="dgom-ui-pintar-photo-wrap-panel dgom-ui-pintar-photo-wrap-panel-score">
			...
			<article class="col-lg-8 col-sm-12 pull-ok">
				...
				<?php
				echo CHtml::checkBox ( "b_mencion", $photoCalificar->b_mencion, array (
			...
			<div class="row margin-0">
				...
				foreach ( $rubros as $rubro ) {
					$suma =$suma+$rubro->num_calificacion; 
					?>
					<div class="col-sm-12 dgom-ui-score-sliders">
					<div class="row rowRange">
						<div class="col-sm-10">
							<div class="example-wrap">
								<h4 class="example-title"><?=$rubro->idRubro->txt_nombre?></h4>
								<div class="example">
									<div class="asRange rangeUi asRange-<?=$index?>"
										data-plugin="asRange" data-namespace="rangeUi" data-value="<?=$rubro->num_calificacion?>"></div>
								</div>
							</div>
						...
						<div class="col-sm-2" tabindex="0">
								<?=$form->hiddenField($photoCalificar, "WrkPicsCalificaciones[$rubro->id_rubro]num_calificacion", array("class"=>"dgom-js-sum dgom-js-calificacion-".$index, "value"=>$rubro->num_calificacion))?>
								<span class="rangeRight js-valRange-<?=$index?>"><?=$rubro->num_calificacion?></span>
						</div>
				...
				<div class="col-lg-12 col-sm-12 col-md-12  text-center" style="margin-top: 60px;">
					...
					<div class="dgom-ui-content-input-progress-canvas">
						<input type="text" class="knob-chart knob-example-1"
							...
							data-max="100" value="<?=$suma?>" disabled data-readonly="true"/>
					</div>
				</div>
			</div>
