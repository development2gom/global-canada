		...
		<div
			...
			<div class="grid-stack grid-stack-3848 grid-stack-animate"
				...
				foreach($picConflictos as $pic){?>
					...
					<div
						class="grid-stack-item-content panel ui-draggable-handle img-box bg-box-one" style="background:url('<?php echo Yii::app ()->params ['pathBaseImages']."idu_".$pic->txt_usuario_number."/medium_".$pic->txt_file_name?>')  no-repeat 50%; background-size: cover;">
						<div class="smallFull">
							<?php echo CHtml::link('
