...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl ?>/assets/css/jquerysctipttop.css">
		...
		<nav
			...
			<div class="navbar-container container-fluid">
	          ...
	          <?php
											...
											echo CHtml::link ( '<span class="name-user">'.Yii::t('site','sessionStar').'</span>
