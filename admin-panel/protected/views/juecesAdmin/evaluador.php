<div id="page" class="photo-page">
	...
	<section class="dgom-ui-photo-wrapper">
		<div class="dgom-ui-photo">
			<img style="display:none" id="dgom-js-bkgdImage" src="<?php echo Yii::app ()->params ['pathBaseImages'].'con_'.$concurso->txt_token."/idu_".$photoCalificar->iD->txt_usuario_number."/large_".$photoCalificar->txt_file_name?>" alt="<?=$photoCalificar->txt_pic_name?>">
		</div>
	</section>
