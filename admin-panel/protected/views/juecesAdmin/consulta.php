			...
			<div class="col-md-7 grid grid7 dgom-ui-column-left">
				...
				<div class="dgom-ui-consulta-wrapper-contend-foto">
					...
					<div class="dgom-ui-consulta-wrapper-contend-detalles">
						<div style="
    margin-right: 40px;
" class="dgom-ui-consulta-wrapper-contend-detalles-int dgom-js-consulta-leer-descripcion">
						...
						<div style="
    margin-left: 40px;
" class="dgom-ui-consulta-wrapper-contend-detalles-int dgom-js-download-image">
