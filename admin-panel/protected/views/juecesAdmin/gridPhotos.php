...
foreach($picsCategoria as $pic){?>
					...
					<div
						...
						style="background:url('<?php echo Yii::app ()->params ['pathBaseImages'].'con_'.$this->tokenContest."/idu_".$pic->iD->txt_usuario_number."/small_".$pic->txt_file_name?>')  no-repeat 50%; background-size: cover;">
						<div class="smallFull">
							<div class="icon-middle">
								<p>
								<?php echo CHtml::link('<i class="icon wb-pencil" aria-hidden="true"></i>', array("adminPanel/viewRatingPhoto", "id"=>$pic->txt_pic_number))?>
								</p>
								<a href="#">View Photo</a>
							</div>
						</div>
