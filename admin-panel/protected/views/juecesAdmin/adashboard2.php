			...
			<div
				...
				foreach ( $picsCategoria as $pic ) {
					...
					<div
						...
						class="grid-stack-item-content panel ui-draggable-handle img-box bg-box-one" style="background:url('<?php echo Yii::app ()->params ['pathBaseImages'].'con_'.$this->tokenContest.'/'."idu_".$pic->iD->txt_usuario_number."/small_".$pic->txt_file_name?>')  no-repeat 50%; background-size: cover;">
...
echo CHtml::link ( '
							...
							"adminPanel/viewRatingPhoto/".$pic->txt_pic_number 
...
?>
						...
						<?php }?>
							...
							<a href="<?=Yii::app()->request->baseUrl.'/juecesAdmin/downloadImage?picture='.$pic->txt_file_name.'&token='.$this->tokenContest."&u=".$pic->iD->txt_usuario_number?>" class="js-download-picture btn btn-floating btn-primary btn-sm-download">
...
$(".js-download-picture").on("click", function(e){
