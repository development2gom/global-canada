...
$porcentajeAvance = ViewAvanceTotalJuez::model ()->findAll ( array (
		"condition" => "txt_token=:token", "params"=>array(':token'=>$this->tokenContest) 
) );
...
<link rel="stylesheet"
	href="<?php echo Yii::app()->theme->baseUrl ?>/assets/css/ladda-themeless.min.css">
...
<title><?= Yii::t('site','progreso'); ?></title>
...
<body class="dashboard body-page-full" style="rgba(255, 255, 255, 0);">
    ...
    <![endif]-->
		<nav
          ...
          <?=CHtml::link ( '<span class="name-user">'.Yii::t('site','sessionStar').'</span>
                <div class="btn-logout-admin">
                  <span class="icon wb-power" aria-hidden="true"></span>
                </div>', array ("logout/" ), array ("class" => "navbar-avatar dropdown-toggle animsition-link","data-animation" => "scale-up","role" => "button" ) );?>
          </li>
			...
			<?php
		$this->renderPartial('//layouts/menu', array('tokenContest'=>$this->tokenContest));
		?>
